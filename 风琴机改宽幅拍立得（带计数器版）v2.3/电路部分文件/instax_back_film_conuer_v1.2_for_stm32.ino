...
#define OLED_RESET     PA4 // Reset pin # (or -1 if sharing Arduino reset pin)
...
int analogPin = PA0; // potentiometer wiper (middle terminal) connected to analog pin 3
...
//  setClockPrescaler(CLOCK_PRESCALER_16);
  ...
  //电压
  vcc = analogRead(analogPin) * 10 / 1024; // readVcc() * 0.001f + 1.05f;
  //绘制
  initLed();
}
